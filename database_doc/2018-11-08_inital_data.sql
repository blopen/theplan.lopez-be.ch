...
INSERT INTO `exercise` (`name`, `user_id`) VALUES ('Langhantel Bankdrücken', '0');
INSERT INTO `exercise` (`name`, `user_id`) VALUES ('Kurzhantel Bankdrücken', '0');
INSERT INTO `exercise` (`name`, `user_id`) VALUES ('Kurzhantel Bankdrücken Schreg', '0');
INSERT INTO `exercise` (`name`, `user_id`) VALUES ('Langhantel Bankdrücken Schreg', '0');
INSERT INTO `exercise` (`name`, `user_id`) VALUES ('Butterfly Maschine', '0');
INSERT INTO `exercise` (`name`, `user_id`) VALUES ('Butterfly Freihantel', '0');
INSERT INTO `exercise` (`name`, `user_id`) VALUES ('Butterfly Kabelzug', '0');